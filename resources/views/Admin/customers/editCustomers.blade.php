                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="edit_form_submit">
                        ...
                        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                            ...
                            <form class="form-validate updateCustomers">
                            @method("PUT")
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-1">
                                            ...
                                            <input id="dob" type="text" id="dob" class="form-control birthdate-picker" value="<?= isset($data->date_of_birth)?(date('d-m-Y', strtotime($data->date_of_birth))):''  ?>dob" placeholder="YYYY-MM-DD" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-1">
        ...
        var updateForm = new FormData();
                    ...
                    $.ajax(settings).done(function(response) {
                        if(response.errors){
                            ...
                            Toast.fire({
                                icon: 'success',
                                title: 'Customers is sucessfully Updated!'
                            })
