                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="role" class="form-control"
                                                    placeholder="Enter Role..." name="role" required />
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="permissions">Select Permissions</label>
                                                <select name="permissions[]" id="permissions" class="select2 form-select"
                                                    required multiple>
                                                    <option value=""></option>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="role">Role</label>
                                                <input type="text" id="edit_role" class="form-control"
                                                    placeholder="Enter Role..." name="role" required />
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="permissions">Select Permissions</label>
                                                <select name="permissions[]" id="edit_permissions"
        ...
        $(document).ready(function() {
            $('#dataTable').DataTable({
                ...
                buttons: [{
                    ...
                    {
                        text: feather.icons['settings'].toSvg({
